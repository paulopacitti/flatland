...
public:
  ...
  /**
   * Logs an informational message. The message is prefixed with a timestamp and
   * the "INFO" label. The log entry is then added to the internal message list
   * and printed to the console in green color.
   */
